 ...
 */
com.lumpofcode.kmeans.kppInitializer = function(observations, k) {
    /**
    ...
    for(let c = 1; c < k; c += 1) {        
        ...
        for(i = 0; i < index.length; i += 1) {
            distanceToCloseCentroid[index[i]] = com.lumpofcode.kmeans.distanceSquared(observations[index[i]], observations[centroids[c - 1]]);
            totalWeight += distanceToCloseCentroid[i];
        }  
